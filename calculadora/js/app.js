...
function montarEmbedDiscord(r) {
  ...
  const campos = [
    ...
    { name: "Valor total", value: moeda(r.total), inline: true },
    { name: "Tipo de preço", value: r.modoPreco === "minimo" ? "Mínimo" : "Normal", inline: true },
  ];
...
// ===================================================================
// Dificultar cópia/inspeção da página. IMPORTANTE: isso não é
// segurança de verdade — qualquer pessoa com conhecimento técnico
// ainda consegue ver o código (ex.: "Salvar página", aba de rede do
// navegador, ou simplesmente desativando JavaScript). Serve só para
// desestimular o usuário comum. Campos de formulário continuam
// funcionando normalmente (selecionar, copiar, colar, clique direito).
// ===================================================================
const CAMPOS_EDITAVEIS = ["INPUT", "TEXTAREA", "SELECT"];

document.addEventListener("contextmenu", (e) => {
  if (CAMPOS_EDITAVEIS.includes(e.target.tagName)) return;
  e.preventDefault();
});
